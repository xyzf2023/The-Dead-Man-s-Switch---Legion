...
{
    /// <summary>
    /// LordToil：防御点等待，延迟后让携带者执行呼叫 Job
    /// </summary>
    public class LordToil_DefendPointWithJobAssignment : LordToil_DefendPoint
    {
        /// <summary>
        ...
        public LordToil_DefendPointWithJobAssignment(IntVec3 defendPoint) : base(defendPoint)
        {
        }
